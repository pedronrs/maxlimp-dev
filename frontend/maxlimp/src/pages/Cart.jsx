  ...
  if (cart.length === 0) {
    return (
      <div className="flex flex-col gap-4 items-center justify-center h-screen">
        ...
        <Link to='/'><button className="w-full rounded-md px-6 py-2 bg-indigo-600 text-white transition-all duration-300 hover:bg-indigo-700 flex items-center justify-center gap-4 text-sm uppercase tracking-wide">Retorne à loja!</button></Link> 
      </div>
    );
  }
          ...
          <Table aria-label="cart table">
            ...
            <TableBody>
              {cart.map((product, index) => (
                <TableRow key={index} className="odd:bg-gray-100 even:bg-gray-200">
